...
pub fn run<R: ProducableGraphicsRuntime<DrmContext> + EguiCapableGraphicsRuntime>(
    ...
    let mut graphics_runtime = R::new(&context, GraphicsRequirements::default());
...
impl DisplayContext for DrmContext {
